...
@Data
@TableName("signup_change_request")
public class SignupChangeRequest {
    private String id;                          // 主键ID
    private String signupId;                    // 关联报名记录ID

    private String prizeCoachIdBefore;
    private String prizeCoachIdAfter;

    private String leaderIdBefore;              // 队长ID（修改前）
    private String leaderIdAfter;               // 队长ID（修改后）

    private String member1IdBefore;             // 成员1ID（修改前）
    private String member1IdAfter;              // 成员1ID（修改后）

    private String member2IdBefore;             // 成员2ID（修改前）
    private String member2IdAfter;              // 成员2ID（修改后）
